...
assert(helpers.defineBestAction(hand1,pile1) == 6, "Test on best action with joker failed")
assert(helpers.defineBestAction(hand2,pile2) == 4, "Test on best action with duplicate failed")